...
# 스프라이트(캐릭터) 불러오기
character = pygame.image.load("D:\\Python_git\\Class_Python\\pygame\\character.png")
...
# 적 캐릭터
enemy = pygame.image.load("D:\\Python_git\\Class_Python\\pygame\\enemy.png")
...
while running:
    ...
    # 캐릭터가 1초에 100만큼 이동을 해아함
    # 10fps : 1초동안 10번 동작 -> 1번에 몇만큼 이동? > 10만큼
    # 20fps : 1초동안 20번 동작 -> 1번에 5만큼 이동
